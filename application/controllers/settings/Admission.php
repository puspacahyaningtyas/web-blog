...
class Admission extends Admin_Controller {
	...
	public function index() {
		$this->vars['title'] = 'PENGATURAN PENERIMAAN '.(get_school_level() == 5 ? 'MAHASISWA' : 'PESERTA DIDIK').' BARU';
		$this->vars['settings'] = $this->vars['admission_settings'] = true;
		$this->vars['content'] = 'settings/admission';
	...
	public function pagination() {
		...
		$query = $this->m_settings->get_where($keyword, $limit, $offset, 'admission', $sort_field, $sort_type);
