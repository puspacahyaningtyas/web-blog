...
class Employment extends Admin_Controller {
	...
	public function __construct() {
		...
		$this->pk = M_employment::$pk;
		$this->table = M_employment::$table;
	}
	...
	public function index() {
		$this->vars['title'] = 'PEKERJAAN SUAMI / ISTRI';
		$this->vars['employees'] = $this->vars['employee_reference'] = $this->vars['employment'] = true;
		$this->vars['content'] = 'employment/read';
	...
	public function pagination() {
		...
		$query = $this->m_employment->get_where($keyword, $limit, $offset, $sort_field, $sort_type);
		$total_rows = $this->m_employment->total_rows($keyword);
