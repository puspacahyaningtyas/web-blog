...
class Salary_sources extends Admin_Controller {
	...
	public function index() {
		...
		$this->vars['employees'] = $this->vars['employee_reference'] = $this->vars['salary_sources'] = true;
	...
	public function pagination() {
		...
		$query = $this->m_salary_sources->get_where($keyword, $limit, $offset, $sort_field, $sort_type);
