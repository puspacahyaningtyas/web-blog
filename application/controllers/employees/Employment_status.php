...
class Employment_status extends Admin_Controller {
	...
	public function index() {
		...
		$this->vars['employees'] = $this->vars['employee_reference'] = $this->vars['employment_status'] = true;
	...
	public function pagination() {
		...
		$query = $this->m_employment_status->get_where($keyword, $limit, $offset, $sort_field, $sort_type);
