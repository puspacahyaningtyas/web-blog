...
class Institutions_lifter extends Admin_Controller {
	...
	public function __construct() {
		parent::__construct();
		$this->load->model(['m_institutions_lifter']);
		$this->pk = M_institutions_lifter::$pk;
		$this->table = M_institutions_lifter::$table;
	}
	...
	public function index() {
		...
		$this->vars['employees'] = $this->vars['employee_reference'] = $this->vars['institutions_lifter'] = true;
		$this->vars['content'] = 'institutions_lifter/read';
	...
	public function pagination() {
		...
		$query = $this->m_institutions_lifter->get_where($keyword, $limit, $offset, $sort_field, $sort_type);
		$total_rows = $this->m_institutions_lifter->total_rows($keyword);
