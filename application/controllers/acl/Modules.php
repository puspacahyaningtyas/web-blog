...
class Modules extends Admin_Controller {
	...
	public function pagination() {
		...
		$query = $this->m_modules->get_where($keyword, $limit, $offset, $sort_field, $sort_type);
	...
	private function validation() {
		...
		$val->set_rules('module_name', 'Module name', 'trim|required');
		$val->set_rules('module_description', 'Module name', 'trim');
