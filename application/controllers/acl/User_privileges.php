...
class User_privileges extends Admin_Controller {
	...
	public function __construct() {
		parent::__construct();
		$this->load->model(['m_user_groups', 'm_modules', 'm_user_privileges']);
	...
	public function pagination() {
		...
		$query = $this->m_user_privileges->get_where($keyword, $limit, $offset, $sort_field, $sort_type);
	...
	private function validation() {
		...
		$val->set_rules('user_group_id', 'User Group', 'trim|required|numeric');
		$val->set_rules('module_id', 'Module', 'trim|required|numeric');
