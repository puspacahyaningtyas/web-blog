...
class Quotes extends Admin_Controller {
	...
	public function pagination() {
		...
		$query = $this->m_quotes->get_where($keyword, $limit, $offset, $sort_field, $sort_type);
	...
	private function validation() {
		...
		$val->set_rules('quote', 'Quote', 'trim|required');
		$val->set_rules('quote_by', 'Quote By', 'trim|required');
