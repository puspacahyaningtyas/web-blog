...
class Post_categories extends Admin_Controller {
	...
	public function index() {
		...
		$this->vars['options_categories'] = json_encode($this->m_post_categories->dropdown());
	...
	public function pagination() {
		...
		$query = $this->m_post_categories->get_where($keyword, $limit, $offset, $sort_field, $sort_type);
