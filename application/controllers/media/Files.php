...
class Files extends Admin_Controller {
	...
	public function pagination() {
		...
		$query = $this->m_files->get_where($keyword, $limit, $offset, $sort_field, $sort_type);
