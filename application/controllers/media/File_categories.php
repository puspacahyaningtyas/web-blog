...
class File_categories extends Admin_Controller {
	...
	public function pagination() {
		...
		$query = $this->m_file_categories->get_where($keyword, $limit, $offset, $sort_field, $sort_type);
	...
	private function fill_data() {
		return [
			...
			'slug' => url_title(strtolower($this->input->post('category', true)))
		];
	}
	...
	private function validation() {
		...
		$val->set_rules('category', 'Quote', 'trim|required');
		$val->set_rules('description', 'Quote By', 'trim|required');
