...
class Student_status extends Admin_Controller {
	...
	public function index() {
		...
		$this->vars['students'] = $this->vars['student_reference'] = $this->vars['student_status'] = true;
	...
	public function pagination() {
		...
		$query = $this->m_student_status->get_where($keyword, $limit, $offset, $sort_field, $sort_type);
