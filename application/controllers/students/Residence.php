...
class Residence extends Admin_Controller {
	...
	public function __construct() {
		...
		$this->pk = M_residence::$pk;
		$this->table = M_residence::$table;
	}
	...
	public function index() {
		...
		$this->vars['students'] = $this->vars['student_reference'] = $this->vars['residence'] = true;
		$this->vars['content'] = 'residence/read';
	...
	public function pagination() {
		...
		$query = $this->m_residence->get_where($keyword, $limit, $offset, $sort_field, $sort_type);
		$total_rows = $this->m_residence->total_rows($keyword);
