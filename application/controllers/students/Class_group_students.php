...
class Class_group_students extends Admin_Controller {
	...
	public function __construct() {
		parent::__construct();
		$this->load->model(['m_class_group_students', 'm_class_groups']);
		$this->pk = M_class_group_students::$pk;
		$this->table = M_class_group_students::$table;
	}
	...
	public function index() {
		...
		$this->vars['students'] = $this->vars['class_group_students'] = true;
		$this->vars['ds_class_groups'] = json_encode($this->m_class_groups->dropdown());
		$this->vars['content'] = 'class_group_students/read';
	...
	public function pagination() {
		...
		$query = $this->m_class_group_students->get_where($keyword, $limit, $offset, $sort_field, $sort_type);
		$total_rows = $this->m_class_group_students->total_rows($keyword);
