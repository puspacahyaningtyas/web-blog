...
class Monthly_income extends Admin_Controller {
	...
	public function __construct() {
		parent::__construct();
		$this->load->model(['m_monthly_income']);
		$this->pk = M_monthly_income::$pk;
		$this->table = M_monthly_income::$table;
	}
	...
	public function index() {
		$this->vars['title'] = 'PENGHASILAN ORANG TUA';
		$this->vars['students'] = $this->vars['student_reference'] = $this->vars['monthly_income'] = true;
		$this->vars['content'] = 'monthly_income/read';
	...
	public function pagination() {
		...
		$query = $this->m_monthly_income->get_where($keyword, $limit, $offset, $sort_field, $sort_type);
		$total_rows = $this->m_monthly_income->total_rows($keyword);
