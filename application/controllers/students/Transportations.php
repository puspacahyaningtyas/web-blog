...
class Transportations extends Admin_Controller {
	...
	public function index() {
		...
		$this->vars['students'] = $this->vars['student_reference'] = $this->vars['transportations'] = true;
	...
	public function pagination() {
		...
		$query = $this->m_transportations->get_where($keyword, $limit, $offset, $sort_field, $sort_type);
