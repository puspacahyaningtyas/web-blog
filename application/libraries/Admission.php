...
class Admission extends TCPDF {
	...
	public function generating_pdf(array $result) {
		...
		} else if ($school_level == 2 || $school_level == 3) { // SMP / SMA
			$content = file_get_contents(VIEWPATH.'admission/pdf_admission_template_23.html');
		} else if ($school_level == 4) { // SMK
			$content = file_get_contents(VIEWPATH.'admission/pdf_admission_template_4.html');
