...
<script type="text/javascript">
	...
	function save_changes() {
		var values = {
			...
			email: $('#email').val(),
			kps_receiver: $('#kps_receiver').val(),
			kps_number: $('#kps_number').val(),
					...
					<div class="tab-pane" id="tab_2">
						<form class="form-horizontal">
							<div class="box-body">
								...
								<div class="form-group">
									<label for="kps_receiver" class="col-sm-4 control-label">Penerima KPS/PKH/KIP ?</label>
									<div class="col-sm-8">
										<?=form_dropdown('kps_receiver', ['true' => 'Ya', 'false' => 'Tidak'], $query->kps_receiver, 'id="kps_receiver" class="form-control"');?>
									</div>
								</div>
								<div class="form-group">
									<label for="kps_number" class="col-sm-4 control-label">No. KPS/KKS/PKH/KIP</label>
									<div class="col-sm-8">
									  <input type="text" class="form-control" id="kps_number" value="<?=$query->kps_number ? $query->kps_number : '';?>">
									</div>
								</div>
								<div class="form-group">
