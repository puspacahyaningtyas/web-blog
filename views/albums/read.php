...
<script type="text/javascript">
    ...
    new GridBuilder( _grid , {
        ...
        reduce_column: 7,
        extra_buttons: '<a href="' + _BASE_URL + 'media/photos' + '" class="btn btn-warning btn-sm" data-toggle="tooltip" data-placement="top" title="List Images"><i class="fa fa-picture-o"></i></a>'
    });
