				...
				<ul class="treeview-menu">
					...
					<li <?=isset($employee_reference) ? 'class="active"':'';?>>
						...
						<ul class="treeview-menu">
							...
							<li <?=isset($employment_types) ? 'class="active"':'';?>><a href="<?=site_url('employees/employment_types');?>"><i class="fa fa-chevron-circle-right"></i> Jenis GTK</a></li>
					...
					<li <?=isset($import_employees) ? 'class="active"':'';?>><a href="<?=site_url('employees/import');?>"><i class="fa fa-upload"></i> Import GTK</a></li>
				</ul>
			</li>
			<?php } ?>
		<?php } ?>
