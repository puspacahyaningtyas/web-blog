	...
	function get_menus() {
		$.get(_BASE_URL + 'appearance/menus/get_menus', function(response) {
			...
			for (var z in res) {
				...
				+ '<td>' + (res[ z ].is_deleted == 'true' ? '<i class="fa fa-warning text-red"></i>':'<i class="fa fa-check text-green"></i>') + '</td>'
...
<section class="content-header">
	<h1><i class="fa fa-mouse-pointer text-red"></i> <?=$title;?></h1>
 </section>
				...
				<div class="box-footer">
					<div class="row">
						<div class="col-md-6">
							<div class="checkbox">
								<label>
									<input type="checkbox" class="checkall-pages"> Select All
								</label>
							</div>
						</div>
						<div class="col-md-6">
							<button onclick="save_pages()" type="submit" class="btn btn-sm btn-primary pull-right"><i class="fa fa-send"></i> Add to Menu</button>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="box-footer">
					<div class="row">
						<div class="col-md-6">
							<div class="checkbox">
								<label>
									<input type="checkbox" class="checkall-post-categories"> Select All
								</label>
							</div>
						</div>
						<div class="col-md-6">
							<button onclick="save_post_categories()" type="submit" class="btn btn-sm btn-primary pull-right"><i class="fa fa-send"></i> Add to Menu</button>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="box-footer">
					<div class="row">
						<div class="col-md-6">
							<div class="checkbox">
								<label>
									<input type="checkbox" class="checkall-file-categories"> Select All
								</label>
							</div>
						</div>
						<div class="col-md-6">
							<button onclick="save_file_categories()" type="submit" class="btn btn-sm btn-primary pull-right"><i class="fa fa-send"></i> Add to Menu</button>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="box-footer">
					<div class="row">
						<div class="col-md-6">
							<div class="checkbox">
								<label>
									<input type="checkbox" class="checkall-modules"> Select All
								</label>
							</div>
						</div>
						<div class="col-md-6">
