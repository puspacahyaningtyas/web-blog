...
<script type="text/javascript">
    ...
    new GridBuilder( _grid , {
        ...
        can_add:false,
        extra_buttons: '<a class="btn btn-warning btn-sm add" href="' + _BASE_URL + 'blog/posts/create'+'" data-toggle="tooltip" data-placement="top" title="Add"><i class="fa fa-plus"></i></a>' 
    });
</script>