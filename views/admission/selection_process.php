...
<section class="content-header">
   <h1><i class="fa fa-hourglass-start text-red"></i> <?=ucwords(strtolower($title));?></h1>
 </section>
 	...
 	<div class="panel panel-default">
		<div class="panel-body">
			<form class="form-horizontal">
               ...
               <div class="form-group">
                  <label for="registrants" class="col-sm-3 control-label">Calon Peserta Didik Baru</label>
                  <div class="col-sm-9">
