...
<script type="text/javascript">
	...
	form_fields.push(
		...
		{ label:'Penerima KPS/PKH/KIP', name:'kps_receiver', placeholder:'Penerima KPS/PKH/KIP', type:'select', datasource:DS.TrueFalse },
		{ label:'No. KPS/KKS/PKH/KIP', name:'kps_number', placeholder:'No. KPS/KKS/PKH/KIP' },
