...
<html lang="en">
	<head>
		...
		<?=link_tag('views/themes/journal/css/bootstrap.css')?>
		<?=link_tag('views/themes/journal/css/font-awesome.min.css')?>
		<?=link_tag('views/themes/journal/css/sm-core-css.css')?>
		<?=link_tag('views/themes/journal/css/jquery.smartmenus.bootstrap.css')?>
		...
		<?=link_tag('views/themes/journal/css/style.css')?>
		...
		<nav class="navbar navbar-inverse navbar-fixed-top">
			<div class="container">
				...
				<div id="navbar" class="navbar-collapse collapse">
					...
					<form class="navbar-form navbar-right" action="<?=site_url('hasil-pencarian')?>" method="POST">
