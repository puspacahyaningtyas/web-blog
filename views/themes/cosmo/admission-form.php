	...
	<form class="form-horizontal admission-form" role="form">
		...
		<div class="tab-content">
			<div role="tabpanel" class="tab-pane active" id="tab_1">
				...
				<?php if ($this->session->userdata('school_level') == 4 || $this->session->userdata('school_level') == 5) { ?>
				<div class="form-group">
				...
				<?php if ($this->session->userdata('school_level') == 2 || $this->session->userdata('school_level') == 3 || $this->session->userdata('school_level') == 4) { ?>
				<div class="form-group">
					<label for="prev_exam_number" class="col-sm-4 control-label">Nomor Peserta Ujian</label>
					<div class="col-sm-8">
						<input type="text" value="<?php echo set_value('prev_exam_number')?>" class="form-control" id="prev_exam_number" name="prev_exam_number" placeholder="Nomor Peserta Ujian Nasional Sebelumnya">
					</div>
				</div>
				<div class="form-group">
			...
			<div role="tabpanel" class="tab-pane" id="tab_2">
				...
				<!-- Khusus Selain SD -->
				<?php if ($this->session->userdata('school_level') != 1) { ?>
				<div class="form-group">
				...
				<div class="form-group">
					<label for="email" class="col-sm-4 control-label">Penerima KPS / KKS / PKH / KIP <span style="color: red">*</span></label>
					<div class="col-sm-8">
						<select name="kps_receiver" id="kps_receiver" class="form-control" onchange="change_kps_number_field()" onblur="change_kps_number_field()" onmouseup="change_kps_number_field()">
				...
				<div class="form-group kps_number">
					<label for="kps_number" class="col-sm-4 control-label">No. KPS / KKS / PKH / KIP</label>
					<div class="col-sm-8">
						<input type="text" value="<?php echo set_value('kps_number')?>" class="form-control" id="kps_number" name="kps_number">
					</div>
				</div>
				<div class="form-group">
			...
			<div role="tabpanel" class="tab-pane" id="tab_7">
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<div class="checkbox">
							<label>
								<input type="checkbox" name="declaration" id="declaration"> Saya menyatakan dengan sesungguhnya bahwa isian data dalam formulir ini adalah benar. Apabila ternyata data tersebut tidak benar / palsu, maka saya bersedia menerima sanksi berupa <strong>Pembatalan</strong> sebagai <strong>Calon <?=$this->session->userdata('school_level') == 5 ? 'Mahasiswa' : 'Peserta Didik' ?></strong> <?=$this->session->userdata('school_name')?>
							</label>
						</div>
					</div>
				</div>
